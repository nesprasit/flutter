...
import 'package:flutter_architecture_mvvm_0/src/domain/network/NetworkResponse.dart';
...
class Network {
  ...
  Future<NetworkResponse<dynamic>> get({
    ...
    try {
      final responseResult =
          await http.get(_getUrl(endpoint, param), headers: headers);
  ...
  NetworkResponse _onHandlerResponseModel(
      BaseResponseModel base, dynamic json) {
